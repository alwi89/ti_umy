...
<!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <?php } ?>
                ...
                <div style="clear: both;">&nbsp;</div>
                <b>Tanggapi dengan komentar</b><br />
                <form method="post" action="komentar_proses.php">
                  <input type="hidden" name="id_hasil" value="<?php echo $b['id_hasil_penelitian']; ?>">
                  <textarea name="komentar" cols="40" rows="5" class="form-control" required></textarea>
                  <input type="submit" value="Kirim" class="btn btn-primary" style="float:right;" />
                </form>
                <?php
