...
<html>
  <head>
    ...
    <title>admin penelitian teknologi informasi UMY</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="?h=berita">
                <i class="fa fa-dashboard"></i> <span>Berita</span></i>
              </a>
            </li>
            <li class="treeview">
              <a href="?h=agenda">
            ...
            <li class="treeview">
              <a href="?h=dosen">
                <i class="fa fa-dashboard"></i> <span>Data Dosen</span></i>
              </a>
            </li>
            <li class="treeview">
              <a href="?h=History">
                <i class="fa fa-dashboard"></i> <span>History</span></i>
              </a>
            </li>
            <li class="treeview">
              <a href="?h=hasil">
                <i class="fa fa-dashboard"></i> <span>Hasil Penelitian</span></i>
              </a>
            </li>
            <li class="treeview">
              <a href="?h=komentar">
                <i class="fa fa-dashboard"></i> <span>Komentar</span></i>
              </a>
            </li>
            <li class="treeview">
              <a href="keluar.php">
